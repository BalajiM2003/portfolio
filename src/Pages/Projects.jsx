        ...
        <div>
            ...
            <div data-aos="fade-left" className='text-white flex pt-20 flex-col justify-center items-center w-full pr-8 pl-8 lg:pr-70 lg:pl-70 md:pr-40 md:pl-40 space-y-30'>
                <div className=' shadow-sm  shadow-purple-800 rounded-sm'>
                    ...
                    <img src='./src/assets/ecourses.png' className=' w-full p-8 ' alt='Vite' />
                    <div className='pl-8 pr-8 pt-8  text-transparent bg-clip-text bg-gradient-to-r from-purple-100 to-purple-400'>
                        <p className={` ${isExpanded ? "" : "line-clamp-3"}`}>Developed a dynamic Online Courses Platform using React.js, Tailwind CSS, and HTML5 with JSX for building an intuitive
                            and responsive user interface. The project features: Routing , React Hooks: like useState, useEffect, and useContext.
                            Custom JSON Data: Created and integrated sample JSON data to populate course and tutor details .Reusable
                            Components: Designed modular components for headers, footers, and course cards to maintain consistency and
                ...
                <div data-aos="fade-right" className=' shadow-sm  shadow-purple-800 rounded-sm'>
                    ...
                    <img src='./src/assets/movie.png' className=' w-full p-8 ' alt='Vite' />
                    <div className='pl-8 pr-8 pt-8  text-transparent bg-clip-text bg-gradient-to-r from-purple-100 to-purple-400 '>
                        <p className={` ${isExpanded ? "" : "line-clamp-3"}`}> Developed a feature-rich Movie Search Application using React.js, Bootstrap 5, CSS, and HTML5 with JSX for an
                            intuitive and responsive user interface. The project highlights include: Routing: Enabled smooth navigation
                            between search results and detailed movie information . React Hooks , API Integration: Consumed a public movie
                            API to fetch and display movie data, including titles, posters, descriptions, and ratings.Dynamic Linking:
                            Integrated external links directing users to the IMDb page of selected movies.</p></div>
                    <button
                        onClick={() => setIsExpanded(!isExpanded)}
                        className=" pl-8  cursor-pointer  text-transparent bg-clip-text bg-gradient-to-r from-purple-100 to-purple-400 "
                    >
                ...
                <div data-aos="fade-left" className=' shadow-sm  shadow-purple-800 rounded-sm'>
                    ...
                    <img src='./src/assets/perfumy.png' className=' w-full p-8 ' alt='Vite' />
                    <div className='pl-8 pr-8 pt-8  text-transparent bg-clip-text bg-gradient-to-r from-purple-100 to-purple-400 '>
